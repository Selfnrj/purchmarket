...
export default function kundnummer() {  
  ...
  return (
    <div className="my-16">
      <div className="bg-[#DFEDFF] p-16 rounded-3xl max-w-2xl mx-auto">
        <h1 className="leading-tight mb-8 text-4xl font-black text-center">Kundnummer</h1>
        <div className="flex justify-between p-4 border border-transparent border-b-blue-200">
          <b>Catell</b> 
          <span>{catell}</span>
        </div>
        <div className="flex justify-between p-4 border border-transparent border-b-blue-200">
